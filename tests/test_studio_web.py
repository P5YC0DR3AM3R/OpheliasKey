...
def test_every_page_has_the_site_nav(client):
    for path, current in (("/", "Ledger"), ("/studio", "Growth"), ("/studio/full", "Studio · full working")):
        html = client.get(path).text
        assert 'class="sitenav"' in html, path
        assert 'href="/studio"' in html and 'href="/studio/full"' in html and "/review" not in html
